...
let shaders = [
  {
    ...
    fragmentShaderPath: "/lively-jekyll-website/assets/shaders/rain.frag",
    scale: 1,
  },
  {
    name: "snow",
    ...
    fragmentShaderPath: "/lively-jekyll-website/assets/shaders/snow.frag",
    scale: 0.75,
  },
  {
    name: "clouds",
    ...
    fragmentShaderPath: "/lively-jekyll-website/assets/shaders/clouds.frag",
    scale: 0.25,
  },
  {
    name: "synthwave",
    ...
    fragmentShaderPath: "/lively-jekyll-website/assets/shaders/synthwave.frag",
    scale: 0.75,
  },
  {
    name: "impulse",
    ...
    fragmentShaderPath: "/lively-jekyll-website/assets/shaders/impulse.frag",
    scale: 1,
  },
];
...
async function init() {
  try {
    ...
    shaders[1].uniform.u_tex0.value = await new THREE.TextureLoader().loadAsync("/lively-jekyll-website/assets/media/snow_tree.webp");
    ...
    case "rain":
      {
        ...
        material.uniforms.u_tex0.value = await new THREE.TextureLoader().loadAsync("/lively-jekyll-website/assets/media/rain_mountain.webp");
      }
      break;
    case "snow":
      {
        ...
        material.uniforms.u_tex0_resolution.value = new THREE.Vector2(1920, 1080);
        material.uniforms.u_tex0.value = await new THREE.TextureLoader().loadAsync("/lively-jekyll-website/assets/media/snow_tree.webp");
      }
      break;
    case "clouds":
      {
